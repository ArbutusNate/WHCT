...
const BestOfFiveOptions = props =>
  ...
  <div>
    <input className="bo5-form-item" type="text" placeholder="Name this tournament" name="tName"onChange={props.handleChange}></input>

    <select className="bo5-form-item" name="player1" onChange={props.handleChange}>
      <option value="default"> Choose Player 1 </option>
      <DropDownOption playerList={props.playerList}/>
    </select>
    <select className="bo5-form-item" name="player2" onChange={props.handleChange}>
      <option value="default"> Choose Player 2 </option>
      <DropDownOption playerList={props.playerList}/>
    </select>


    <button className="bo5-form-item" onClick={props.socketGoLive}> Go Live! </button>
