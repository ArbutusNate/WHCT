...
const BestOfFiveGameOptions = props =>
  ...
  <div>
    ...
    <button disabled={props.disableButtons} className="bo5-form-item" name="player2wins" pstring="player2" onClick={props.updateScore}>
      + {props.player2} Win
    </button>
    <br />

    <input className="bo5-form-item" type="submit" value="End and Save Tournament" onClick={props.endSaveTournament} />
  </div>
